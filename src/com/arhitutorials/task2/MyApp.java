...
public class MyApp implements DataConnection {
    ...
    protected static int startYear = 2009;
    protected static int endYear = 2011;
    /**
     * @param args
     */
    ...
    public void saveData(int year, int qq) throws IOException {
        FileOutputStream fis = new FileOutputStream(new File(".\\src\\com\\arhitutorials\\task2\\statistika.txt"), true);
        String s = new String();
        s = COUNT1 + " " + year + " " + qq + "\n";
